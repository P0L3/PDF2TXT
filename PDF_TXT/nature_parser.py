...
def get_authors_and_affiliations(soup): # Doesn't work ehn there is multiple rows of authors
    ...
    """
    elements = soup.find_all('span', style=lambda value: value and ('font-family: GraphikNaturel-Semibold; font-size:9px' in value or 'font-family: GraphikNaturel-Semibold; font-size:5px' in value))
    ...
    for elem in elements:
        ...
        if 'font-size:9px' in elem.get('style', ''):
        ...
        elif 'font-size:5px' in elem.get('style', ''):
    ...
    s8_wb_elem = soup.find_all('span', style=lambda value: value and ('font-family: GraphikNaturel-Regular; font-size:7px' in value))
...
def get_references(soup):
    ...
    s7_mpr_elem = soup.find_all(style=lambda value: value and ('font-family: GraphikNaturel-Regular; font-size:8px' in value or "font-family: GraphikNaturel-RegularItalic; font-size:8px" in value))
