...
from parser import get_title, get_doi, get_from_springerapi, get_authors_and_affiliations, get_references, get_content, get_doi_regex, get_from_doi2bibapi
...
doctype1 = [ 
    ...
    "font-family: BentonSansCond-Bold; font-size:12px", "font-family: BentonSansCond-Bold; font-size:7px", "font-family: BentonSansCond-Regular; font-size:9px", # get_authors_and_affiliations (author, affiliation, affiliation text)
    "font-family: MinionPro-Regular; font-size:9px", "font-family: MinionPro-It; font-size:9px", # get_references
    "font-size:10px" # get_content
]

doctype2 = [
    "font-size:21px", # get_title
    "font-family: PalatinoLinotype-Roman; font-size:8px", # get_doi
    "font-family: PalatinoLinotype-Bold; font-size:10px", "font-family: PalatinoLinotype-Bold; font-size:5px", "font-family: PalatinoLinotype-Roman; font-size:7px", # get_authors_and_affiliations (author, affiliation, affiliation text)
    "font-family: PalatinoLinotype-Roman; font-size:8px", "font-family: GraphikNaturel-RegularItalic; font-size:8px", # get_references (multiple styles (normal, italic))
    "font-size:10px" # get_content
]
