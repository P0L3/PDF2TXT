...
top_n = 50  # Change this value to plot a different number of top nouns
plt.figure(figsize=(10, 12))
plt.barh(overall_noun_counts_df['Noun'][:top_n], overall_noun_counts_df['Count'][:top_n], color='#0072B2')
